  ...
  return (
    ...
    >
      <form
        ...
        className='flex flex-col items-center justify-center mx-auto w-[500px] bg-white h-[650px] rounded-md rounded-tr-[100px]'
      >
        <div className='w-full ml-10 flex items-start flex-col gap-4'>
          ...
          <div>
            <button
              type='submit'
              className='ml-6 shadow uppercase bg-gray-700 w-[200px] py-3 text-white rounded'
            >
              register
            </button>
          </div>
        ...
        <div className='flex items-center flex-col gap-3 mt-10 w-full'>
          <p>
            or <span className='font-bold underline mx-1'>Register </span>with
          </p>
        </div>
